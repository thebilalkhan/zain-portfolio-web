...
function Home() {
  return (
    <>
      <div id='home' className='w-[100%] h-auto bg-gray-100 flex flex-col-reverse md:flex-row  justify-center items-center m-auto  md:px-24 md:py-16 gap-10 ' >


        {/* info div */}
        <div id="home-section" className="w-[70%] md:w-[50%]">
          ...
          <div className=' text-sm lg:text-lg xl:text-xl 2xl:text-2xl'>I have 2+ years of experience as a Frontend Web Developer (HTML, CSS, Javascript,Bootstrap, Tailwind CSS ) Included 1 years as a Reacts Js Developer. Experienced with React Redux and Context Api.</div>
